...
var Client = (function () {
  ...
  _createClass(Client, [{
    ...
    value: function makeRequest(options, payload, statusCode, region, cb) {
      ...
      var sha256sum = '';
      if (!this.anonymous) sha256sum = _crypto2['default'].createHash('sha256').update(payload).digest('hex');
    ...
    key: 'makeBucket',
    value: function makeBucket(bucketName, acl, region, cb) {
      var _this4 = this;

      if (!(0, _helpersJs.isValidBucketName)(bucketName)) {
        throw new errors.InvalidBucketNameError('Invalid bucket name: ' + bucketName);
      }
      if (!(0, _helpersJs.isString)(acl)) {
      ...
      if (!(0, _helpersJs.isValidACL)(acl)) {
    ...
    key: 'getBucketACL',
    value: function getBucketACL(bucketName, cb) {
      if (!(0, _helpersJs.isValidBucketName)(bucketName)) {
        throw new errors.InvalidBucketNameError('Invalid bucket name: ' + bucketName);
      }
      if (!(0, _helpersJs.isFunction)(cb)) {
    ...
    key: 'setBucketACL',
    value: function setBucketACL(bucketName, acl, cb) {
      if (!(0, _helpersJs.isValidBucketName)(bucketName)) {
        throw new errors.InvalidBucketNameError('Invalid bucket name: ' + bucketName);
      }
      if (!(0, _helpersJs.isString)(acl)) {
      ...
      var method = 'PUT';
      var headers = { 'x-amz-acl': acl };
      this.makeRequest({ method: method, bucketName: bucketName, query: query, headers: headers }, '', 200, '', cb);
    }
    ...
    value: function fPutObject(bucketName, objectName, filePath, contentType, callback) {
      ...
      _async2['default'].waterfall([function (cb) {
        ...
        if (size < _this9.minimumPartSize) {
          ...
          var hash = transformers.getHashSummer(_this9.anonymous);
          var start = 0;
          var end = size - 1;
          var autoClose = true;
          if (size === 0) end = 0;
    ...
    value: function putObject(arg1, arg2, arg3, arg4, arg5, arg6) {
      ...
      if (size <= this.minimumPartSize) {
        ...
        (0, _helpersJs.pipesetup)(stream, concater).on('error', function (e) {
          ...
          var sha256sum = '';
          if (!_this10.anonymous) sha256sum = _crypto2['default'].createHash('sha256').update(chunk).digest('hex');
    ...
    value: function presignedGetObject(bucketName, objectName, expires, cb) {
      var _this13 = this;
    ...
    value: function chunkUploader(bucketName, objectName, contentType, uploadId, partsArray, multipartSize) {
      ...
      return _through22['default'].obj(function (chunk, enc, cb) {
        ...
        if (!sha256) sha256 = _crypto2['default'].createHash('sha256');
...
//# sourceMappingURL=flycheck_minio.js.map
